...
function first(modules) { // webpackBootstrap
    // The module cache
    var installedModules = {};

    console.log("Mai Sabse Pahile !")
...
/***/
function zero(module, exports, __webpack_require__) {

    console.log("Mai Line Mai Dusra");
...
function one(module, exports, __webpack_require__) {
    ...
    GameView.prototype.addLivesText = function(ctx) {
        let x = this.game.DIM_X * .87,
            y = this.game.DIM_Y * .05;
...
function two(module, exports, __webpack_require__) {
...
function three(module, exports, __webpack_require__) {
...
function four(module, exports, __webpack_require__) {
...
function six(module, exports, __webpack_require__) {
...
function nine(module, exports, __webpack_require__) {
...
function ten(module, exports, __webpack_require__) {
    ...
    Shield.prototype.draw = function(ctx) {
        ...
        for (let i = 1; i < 21; i++) {
            ...
            if (i < 10) { posX += 7; } else if (i === 10) { posY -= 7; } else if (i < 20) { posX -= 7; } else if (i === 20) { posY -= 7; }
        }
...
function eleven(module, exports, __webpack_require__) {
